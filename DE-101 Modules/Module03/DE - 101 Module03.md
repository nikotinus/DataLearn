...
1. Если еще нет Tableau Desktop и лицензии, то следуйте [инструкции](https://github.com/nikotinus/data-engineering/blob/master/how-to/how-to-tabelau-desktop.md).
...
4. Если вы используете виртуальную машину, то вам необходимо настроить сетевой адаптер виртуальной машины, чтобы машины могли между собой соединяться. Я загрузил [PDF файл](https://github.com/nikotinus/data-engineering/blob/master/DE-101%20Modules/Module03/DE%20-%20101%20Lab%203.1/Vmware%20network%20example.pdf), про который рассказывал в видео. Если будут трудности с настройкой, пишите в slack канале 3го модуля.
...
### Практика
Эдгар подготовил для вас задание. Вы сможете его найти [здесь](https://github.com/nikotinus/data-engineering/tree/master/DE-101%20Modules/Module03/DE%20-%20101%20Lab%203.1/3_11_PowerBI).
...
Как вы знаете 3й модуль был про визаулизацию данных, business intelligence и BI продукты. Наш эксперт по BI и Tableau и автор Телеграмм канала Reveal the Data, Роман Бунин, подготовил для вас [очень интересный проект](https://github.com/nikotinus/data-engineering/blob/master/DE-101%20Modules/Module03/CapstoneProject/readme.md).
...
![img](https://github.com/nikotinus/data-engineering/blob/master/img/de101-module03.png)
